    ...
    function drawChart() {
        ...
        function selectHandler() {
            ...
            if (selectedItem) {
                ...
                // 출력할 문자열 생성
                var message = '선택된 요소: ' + rowLabel + ', ' + columnLabel + ', ' + value;
        ...
        <div id="mainBox" class="fade">
            <div id="topBox">
                <article id="newMusic">
                    <p>NEW Albums</p>
                    <div id="albums">
                        <div><img id="a1" src="../image/a1.jpg" alt="">
                            <div class="album-name" id="t1">
                                <p>앨범 이름</p>
                            </div>
                        </div>
                        <div><img id="a2" src="../image/a2.jpg" alt="">
                            <div class="album-name" id="t2">
                                <p>앨범 이름</p>
                            </div>
                        </div>
                        <div><img id="a3" src="../image/a3.jpg" alt="">
                            <div class="album-name" id="t3">
                                <p>앨범 이름</p>
                            </div>
                        </div>
                        <div><img id="a4" src="../image/a4.jpg" alt="">
                            <div class="album-name" id="t4">
                                <p>앨범 이름</p>
                            </div>
                        </div>
                        <div><img id="a5" src="../image/a5.jpg" alt="">
                            <div class="album-name" id="t5">
                                <p>앨범 이름</p>
                            </div>
                        </div>
                        <div><img id="a6" src="../image/a6.jpg" alt="">
                            <div class="album-name" id="t6">
                                <p>앨범 이름</p>
                            </div>
                        </div>
                        <div><img id="a7" src="../image/a7.jpg" alt="">
                            <div class="album-name" id="t7">
                                <p>앨범 이름</p>
                            </div>
                        </div>
                        <div><img id="a8" src="../image/a8.jpg" alt="">
                ...
                <article id="onlyMyChart">
                    ...
                    <div id="sels">
                        <div id="selStroke">
                            <div id="selAlbumDiv" class="selAlbum">
                            </div>
                            <div class="selRank">
                                <h id="chartDate" class="chartmini">
                                    날짜
                                </h>
                                <h id="alDate" class="chartbold"></h>
                                <br>
                                <p id="chartCount" class="chartmini">
                                    들은 횟수
                                </p>
                                <p id="alCount" class="chartbold"></p>
                                <br>
                                <p id="mName" class="chartbold"></p>
                                <p id="aName" class="chartbold">
